                    ...
                    s(t, [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                return Math.round(
                                    this.props.w /
                                        this.props.FilterItems[0].props.w
                                )
                            },
                        },
                        {
                ...
                return (
                    o(t, [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                return Boolean(
                                    this.getContentsLowercase().includes(t)
                                )
                            },
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                i.trigger('filteringStart'),
                                    ...
                                    (t = Array.isArray(t)
                                        ...
                                        : t.toString())
                                var o = this.searchFilterItems(
                                    this.filterFilterItems(n, t),
                                    r
                                )
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                t.destroy(),
                                    ...
                                    c(e + '[data-multifilter]').off(
                                        'click.Filterizr'
                                    ),
                                    c(e + '[data-shuffle]').off(
                                        'click.Filterizr'
                                    ),
                                    c(e + '[data-search]').off(
                                        'keyup.Filterizr'
                                    ),
                                    c(e + '[data-sortAsc]').off(
                                        'click.Filterizr'
                                    ),
                                    c(e + '[data-sortDesc]').off(
                                        'click.Filterizr'
                                    )
                            },
                        },
    ...
    function (t, e, r) {
        ...
        var n = function (t) {
                var e = t.props,
                    ...
                    s = r.calcColumns(),
                    a = 0,
                    l = Array.apply(null, Array(s)).map(
    ...
    function (t, e, r) {
        ...
        ;(n.prototype = {
            ...
            findNode: function (t, e, r) {
                return t.used
                    ? this.findNode(t.right, e, r) ||
                          this.findNode(t.down, e, r)
                    : e <= t.w && r <= t.h
                    ? t
                    : null
            },
            ...
            growDown: function (t, e) {
                ...
                return (
                    ...
                    (r = this.findNode(this.root, t, e))
                        ? this.splitNode(r, t, e)
                        : null
                )
            },
        }),
